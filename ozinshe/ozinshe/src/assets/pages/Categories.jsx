      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <hr />
              <p className='text-center'>Вы уверены, что хотите удалить этот категори?</p>
            <div className='ml-20 space-x-5 mt-5'>
              <button className=' rounded-xl bg-purple-700 text-center' onClick={() => alert("Для удаление потребуется API от категори")}>
